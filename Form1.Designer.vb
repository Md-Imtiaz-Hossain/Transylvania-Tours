...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        ' 
        resources.ApplyResources(extraActivityBungeeJumping, "extraActivityBungeeJumping")
        ...
        ' 
        resources.ApplyResources(extraActivityFalconry, "extraActivityFalconry")
        extraActivityFalconry.Name = "extraActivityFalconry"
        extraActivityFalconry.UseVisualStyleBackColor = True
        ' 
        ' extraActivityArchery
        ' 
        resources.ApplyResources(extraActivityArchery, "extraActivityArchery")
        ...
        ' visit29August
        ' 
        resources.ApplyResources(visit29August, "visit29August")
        ...
        ' visit22August
        ' 
        resources.ApplyResources(visit22August, "visit22August")
        ...
        ' visit15August
        ' 
        resources.ApplyResources(visit15August, "visit15August")
        ...
        ' visit8August
        ' 
        resources.ApplyResources(visit8August, "visit8August")
        ...
        ' activitySkydiving
        ' 
        resources.ApplyResources(activitySkydiving, "activitySkydiving")
        ...
        ' activityHillWalking
        ' 
        resources.ApplyResources(activityHillWalking, "activityHillWalking")
        ...
        ' activityHorseRiding
        ' 
        resources.ApplyResources(activityHorseRiding, "activityHorseRiding")
        ...
        ' 
        resources.ApplyResources(btnCalculateTotalCost, "btnCalculateTotalCost")
